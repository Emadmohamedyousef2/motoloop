    ...
    ********************************/
    function startKenBurn(container, opt, recalc) {
        ...
        nextsh.find('.defaultimg').each(function() {
            ...
            defimg.data('kenburn', TweenLite.fromTo(kbimg, dur, { autoAlpha: 1, transformPerspective: 1200, transformOrigin: "0% 0%", top: 0, left: 0, scale: imgs.w, x: imgs.x, y: imgs.y }, {
                autoAlpha: 1,
                rotationZ: roe,
                ease: easeme,
                x: imge.x,
                ...
                if (!recalled) {
                    ...
                    nextcaption.find('.rs-pendulum').each(function() {
                        ...
                        if (el.data('timeline') == undefined) {
                            ...
                            el.data('timeline').append(new TweenLite.fromTo(el, speed, { rotation: enddeg, transformOrigin: origin }, {
                                rotation: startdeg,
                                ease: easing,
                                onComplete: function() {
                    ...
                    nextcaption.find('.rs-wave').each(function() {
                        ...
                        if (el.data('timeline') == undefined) {
                            ...
                            el.data('timeline').append(new TweenLite.fromTo(angobj, speed, { a: 360 }, {
                                a: 0,
